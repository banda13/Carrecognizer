...
def sort_train_vs_text(p_train, p_test, min_limit):
    ...
    for category in categories:
        ...
        if len(files_in_category) < min_limit:
        ...
        train_count = int(p_train * category_length)
        test_count = int(p_test * category_length)
...
sort_train_vs_text(0.8, 0.2, 200)
